...
const testimonials = [
  ...
  },
  {
    ...
    location: "Hyderabad",
    rating: 5,
    text: "I wore the Bridal Splendor for my wedding. Every guest asked where I got it. Veera Handloom is truly the finest. The attention to detail in the zari work is breathtaking.",
    initials: "AR",
    color: "#8B4513",
  },
  {
  ...
  },
  {
    ...
    location: "Ahmedabad",
    rating: 5,
    text: "Third purchase from Veera Handloom. Never disappointed. The cotton sarees are perfect for daily wear yet look premium. The quality is consistently outstanding.",
    initials: "KP",
    color: "#1A3A6B",
  },
  {
